...
The **Technical Steering Committee (TSC)** is an [[entities/intersect|Intersect]] body that provides technical steering and approval for governance actions with protocol or engineering implications.

## Position (committee-min-size proposal)

Approved submission of [[proposals/committee-min-size-7-to-5]] on **2026-06-03** ([[sources/reduce-committeeminsize-7-to-5]]). Meeting minutes: [June 3, 2026](https://technicalsteeringcommittee.docs.intersectmbo.org/meeting-minutes/2026-tsc-meeting-minutes/meeting-minutes-june-3-2026).

## Position (Plutus cost models)
